...
#
# Independent copy of 4_osu/cpu_bind.sh. The NUMA-correct pairing of GCD
# to nearest CPU core on a LUMI MI250X node:
#
...
# topology dumped by parse_kfd.py + rocm-topo.
