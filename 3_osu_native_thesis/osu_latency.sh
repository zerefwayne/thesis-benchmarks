#!/bin/bash
#SBATCH --job-name=osu_latency_native
...
RESULT_DIR="results"
mkdir -p "$RESULT_DIR"
CSV_FILE="$RESULT_DIR/osu_latency_native_${SLURM_JOB_ID}.csv"
LOG_FILE="$RESULT_DIR/osu_latency_native_${SLURM_JOB_ID}.log"

BINARY="/users/joglekar/osu-native/osu-micro-benchmarks-7.5/c/mpi/pt2pt/standard/osu_latency"
